  ...
  return (
    <header className="bg-white text-gray-700 p-4 flex justify-between items-center sticky top-0 z-50 shadow-md">
      ...
      <nav className="hidden md:flex space-x-5 items-center">
        ...
        <button className="border-2 border-orange-300 bg-orange-300 text-gray-700 hover:bg-orange-600 hover:text-white focus:bg-orange-600 py-1 px-2 rounded-3xl">
              Contact Us
            </button>
      </nav>
