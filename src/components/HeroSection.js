import React from "react"; // Assume styles are in a separate CSS file

const HeroSection = () => {
  return (
    <section className="hero-section bg-gradient-to-br from-blue-950 via-blue-800 to-orange-500">
        ...
        <div className="hero-content ">
          ...
          <div className="hero-right">
            <div className="hero-logo">
              <img
                src="/images/zoro_white_tm_logo.png" // Replace with actual logo path
