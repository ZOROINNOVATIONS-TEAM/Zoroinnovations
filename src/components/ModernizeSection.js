...
function ModernizeSection() {
  return (
    <section className="text-white">
      ...
      >
        {/* Green Overlay */}
        <div className="absolute inset-0 bg-green-600/80 z-0"></div>

        {/* Content */}
        <div className="relative z-10 max-w-screen-xl mx-auto py-16 text-center">
          <h2 className="text-4xl font-bold mb-6">We Modernize.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 px-4 md:px-0">
            <div className="bg-green-300/30 text-white p-6 rounded-3xl shadow-lg text-start">
              <h3 className="text-lg font-semibold mb-2">Legacy Migration</h3>
