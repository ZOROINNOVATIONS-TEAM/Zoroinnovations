...
const Contacts = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-blue-700 to-red-400 p-4 place-items-center">
      <div className="max-w-7xl mx-auto my-auto">
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden my-auto">
          {/* Header */}
          <div className="px-6 py-6 sm:px-8 sm:py-8 my-auto">
                ...
                {messages.map((message, index) => (
                  <tr key={index} className="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td className="px-6 py-4">
                      <div className="text-blue-600 text-sm hover:text-blue-800 cursor-pointer">
                        {message.email}
                      </div>
                    </td>
                    <td className="px-6 py-4">
                ...
                <div key={index} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-3">
                    <div className="flex-1">
                      ...
                      <p className="text-blue-600 text-sm hover:text-blue-800 cursor-pointer mb-1">
                        {message.email}
                      </p>
                    </div>
                  ...
                  <div className="mb-3">
                    <p className="text-blue-600 text-sm font-medium hover:text-blue-800 cursor-pointer mb-2">
                      {message.subject}
                    </p>
